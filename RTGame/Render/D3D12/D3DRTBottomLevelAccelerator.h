...
private:
  D3DRTBottomLevelAccelerator( D3DDevice& device, D3DCommandList& commandList, D3DResource& vertexBuffer, int vertexCount, int positionElementSize, int vertexStride, D3DResource& indexBuffer, int indexSize, int indexCount, int infoIndex, bool allowUpdate, bool fastBuild );
